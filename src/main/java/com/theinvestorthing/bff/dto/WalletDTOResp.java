...
public class WalletDTOResp {
    ...
    public WalletDTOResp() {
    }

    public WalletDTOResp(String ticker, String companyName, BigDecimal noOfShares, BigDecimal purchasePrice, BigDecimal currentPrice, BigDecimal currentReturn, BigDecimal currentTotal) {
        this.ticker = ticker;
